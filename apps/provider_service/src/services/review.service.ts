...
export class ReviewService {
    ...
    async create(providerId: string, patientId: string, dto: CreateReviewDto) {
        ...
        const profile = await this.profileModel.findOne({ userId: new Types.ObjectId(providerId) });
        console.log(profile);
        ...
        if (existing) throw new BadRequestException('This appointment has already been reviewed');
