    ...
    <tr><td align="center" style="padding:40px 20px;">
      <table width="600" cellpadding="0" cellspacing="0" style="background-color:#FFFFFF;border-radius:12px;box-shadow:0 2px 12px rgba(27,42,74,0.06);">
        <tr><td style="background:linear-gradient(135deg,#1B2A4A,#2C3E6B);border-radius:12px 12px 0 0;padding:30px 40px;text-align:center;">
          <h1 style="color:#C5A55A;font-size:24px;margin:0;font-family:'Playfair Display',serif;">Appointment Cancelled</h1>
        </td></tr>
        <tr><td style="padding:40px;">
          <h2 style="color:#1B2A4A;font-size:20px;margin:0 0 4px;">Hi ${opts.patientName},</h2>
          <p style="color:#2C2C2C;font-size:15px;margin:0 0 24px;">Your appointment has been cancelled.</p>
          <table width="100%" cellpadding="10" cellspacing="0" style="background-color:#F7F5F0;border-radius:8px;margin-bottom:24px;">
            ...
            <tr><td style="font-size:14px;color:#6B7280;">Reference</td><td style="font-size:14px;color:#2C2C2C;font-weight:600;">${opts.bookingRef}</td></tr>
            ${opts.reason ? `<tr><td style="font-size:14px;color:#6B7280;">Reason</td><td style="font-size:14px;color:#E65100;">${opts.reason}</td></tr>` : ''}
          </table>
          <table cellpadding="0" cellspacing="0" style="margin:0 auto;">
            <tr><td style="background-color:#1B2A4A;border-radius:8px;padding:12px 32px;">
              <a href="[dashboard_url]/book-new" style="color:#FFFFFF;font-size:15px;font-weight:600;text-decoration:none;">Book a New Appointment</a>
            </td></tr>
          </table>
