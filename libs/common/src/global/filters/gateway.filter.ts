...
export class CatchGatewayExceptionsFilter extends BaseExceptionFilter {
        ...
        // 4️⃣ Native local HTTP Exceptions
            ...
            object.message = typeof resPayload === 'string' ? resPayload : resPayload.message;
        ...
        res.status(statusCode).json({ message: object.message, code: object.statusCode });
    }
}